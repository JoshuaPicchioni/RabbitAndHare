...
public class JPannelComponent extends JPanel 
{
   ...
   //Timers for the turtle, hare and sleep duration
   Timer turtleTimer;
   Timer hareTimer;
   Timer sleepTimer;
   ...
   //Constructor, takes in the hare's speed, turtles speed and sleep time
   ...
   public void startTimers(int hareSpeed, int turtleSpeed){
      ...
      //Create the TurtleTImer
      turtleTimer = new Timer(turtleSpeed, new ActionListener() {

         //Override the action preformed method
         @Override
         public void actionPerformed(ActionEvent e) {

            //Increment the turtle's posotion by 10
            turtleX = turtleX + 10;
      ...
      //Start the turtle timer
     turtleTimer.start();


     //Create the hare timer
     hareTimer = new Timer(hareSpeed, new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         //Increment the Hare's position by 10
         hareX = hareX + 10;
   ...
   sleepTimer = new Timer(1, new ActionListener() {
